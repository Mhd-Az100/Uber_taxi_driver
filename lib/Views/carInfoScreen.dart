...
class _CarInfoScreenState extends State<CarInfoScreen> {
  ...
  List<String> carTypesList = ['اوفر خاص', 'اوفر مشترك ', 'دراجة'];
                      ...
                      child: TextButton(
                        onPressed: () {
                          if (carModelTextEditingController.text.isEmpty) {
                            displayToastMessage("ادخل نوع السارة.", context);
                          } else if (carNumberTextEditingController
                              .text.isEmpty) {
                            displayToastMessage("ادخل رقم السارة.", context);
                          } else if (carColorTextEditingController
                              .text.isEmpty) {
                            displayToastMessage("ادخل لون السارة", context);
                          } else if (selectedCarType == null) {
                            displayToastMessage("ادخل نوع المركبة.", context);
                          } else {
